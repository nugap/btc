var nugap = (() => {
  ...
  // _entry_yolo.js
  var entry_yolo_exports = {};
  __export(entry_yolo_exports, {
    HDKey: () => HDKey,
    btcSigner: () => btc_signer_exports,
    sha256: () => sha2563
  });
  ...
  // node_modules/@scure/btc-signer/node_modules/@noble/curves/utils.js
  ...
  // node_modules/@scure/btc-signer/node_modules/@noble/curves/abstract/modular.js
  ...
  // node_modules/@scure/btc-signer/node_modules/@noble/curves/abstract/curve.js
  ...
  // node_modules/@scure/btc-signer/node_modules/@noble/hashes/hmac.js
  var _HMAC = class {
  ...
  // node_modules/@scure/btc-signer/node_modules/@noble/curves/abstract/weierstrass.js
  ...
  function ecdh(Point3, ecdhOpts = {}) {
    ...
    const lengths = Object.assign(getWLengths(Point3.Fp, Fn3), { seed: getMinHashLength(Fn3.ORDER) });
  ...
  // node_modules/@scure/btc-signer/node_modules/@noble/curves/secp256k1.js
  var secp256k1_CURVE = {
  ...
  var _Writer = class {
    constructor(stack = []) {
      ...
      __publicField(this, "bitBuf", 0);
      __publicField(this, "bitPos", 0);
      __publicField(this, "viewBuf", new Uint8Array(8));
      __publicField(this, "view");
      __publicField(this, "finished", false);
      this.stack = stack;
  ...
  var _Estimator = class {
    constructor(inputs, outputs, opts) {
      __publicField(this, "baseWeight");
      __publicField(this, "changeWeight");
      __publicField(this, "amount");
      __publicField(this, "requiredIndices", []);
      __publicField(this, "normalizedInputs");
  ...
  function numberToHexUnpadded2(num2) {
    const hex2 = abignumber2(num2).toString(16);
    return hex2.length & 1 ? "0" + hex2 : hex2;
  }
  ...
  function bytesToNumberLE2(bytes) {
    return hexToNumber2(bytesToHex2(copyBytes2(abytes3(bytes)).reverse()));
  }
  ...
  var _Field2 = class {
    constructor(ORDER, opts = {}) {
      ...
      __publicField(this, "BYTES");
      __publicField(this, "isLE");
      __publicField(this, "ZERO", _0n7);
      __publicField(this, "ONE", _1n6);
      __publicField(this, "_lengths");
      __publicField(this, "_sqrt");
      // cached sqrt
      __publicField(this, "_mod");
  ...
  function mulEndoUnsafe2(Point3, point, k1, k2) {
    let acc = point;
    let p1 = Point3.ZERO;
    let p2 = Point3.ZERO;
  ...
  function validateSigOpts2(opts, def2) {
    const optsn = {};
    for (let optName of Object.keys(def2)) {
      optsn[optName] = opts[optName] === void 0 ? def2[optName] : opts[optName];
    }
  ...
  function weierstrass2(params, extraOpts = {}) {
    ...
    const lengths = getWLengths2(Fp, Fn3);
    function assertCompressionIsSupported() {
      if (!Fp.isOdd)
        throw new Error("compression is not supported: Field does not have .isOdd()");
    }
  ...
  function ecdh2(Point3, ecdhOpts = {}) {
    ...
    const lengths = Object.assign(getWLengths2(Point3.Fp, Fn3), { seed: getMinHashLength2(Fn3.ORDER) });
    function isValidSecretKey(secretKey) {
      try {
        const num2 = Fn3.fromBytes(secretKey);
        return Fn3.isValidNot0(num2);
    ...
    function randomSecretKey(seed = randomBytes_(lengths.seed)) {
      return mapHashToField2(abytes3(seed, lengths.seed, "seed"), Fn3.ORDER);
    }
    function getPublicKey(secretKey, isCompressed = true) {
      return Point3.BASE.multiply(Fn3.fromBytes(secretKey)).toBytes(isCompressed);
    }
  ...
  function ecdsa2(Point3, hash, ecdsaOpts = {}) {
    ahash2(hash);
    ...
    const { Fp, Fn: Fn3 } = Point3;
    const { ORDER: CURVE_ORDER2, BITS: fnBits } = Fn3;
    const { keygen, getPublicKey, getSharedSecret, utils: utils3, lengths } = ecdh2(Point3, ecdsaOpts);
    const defaultSigOpts = {
      prehash: true,
      lowS: typeof ecdsaOpts.lowS === "boolean" ? ecdsaOpts.lowS : true,
      format: "compact",
    ...
    const hasLargeCofactor = CURVE_ORDER2 * _2n5 < Fp.ORDER;
    function isBiggerThanHalfOrder(number) {
    ...
    class Signature {
      ...
      static fromBytes(bytes, format = defaultSigOpts.format) {
        ...
        let recid;
        if (format === "der") {
          const { r: r2, s: s2 } = DER2.toSig(abytes3(bytes));
          return new Signature(r2, s2);
        }
        if (format === "recovered") {
          recid = bytes[0];
      ...
      recoverPublicKey(messageHash) {
        ...
        if (!Fp.isValid(radj))
          throw new Error("invalid recovery id: sig.r+curve.n != R.x");
        const x = Fp.toBytes(radj);
        const R = Point3.fromBytes(concatBytes4(pprefix2((recovery & 1) === 0), x));
        const ir = Fn3.inv(radj);
  ...
  var _RIPEMD1602 = class extends HashMD2 {
    constructor() {
      super(64, 20, 8, true);
      __publicField(this, "h0", 1732584193 | 0);
      __publicField(this, "h1", 4023233417 | 0);
    ...
    process(view2, offset) {
      for (let i = 0; i < 16; i++, offset += 4)
        BUF_1602[i] = view2.getUint32(offset, true);
      let al = this.h0 | 0, ar = al, bl = this.h1 | 0, br = bl, cl = this.h2 | 0, cr = cl, dl = this.h3 | 0, dr = dl, el = this.h4 | 0, er = el;
      for (let group = 0; group < 5; group++) {
        const rGroup = 4 - group;
  ...
  var ripemd1602 = /* @__PURE__ */ createHasher2(() => new _RIPEMD1602());

  // node_modules/@scure/bip32/index.js
  var Point2 = secp256k12.Point;
  var { Fn: Fn2 } = Point2;
  var base58check2 = createBase58check(sha2562);
  ...
  var HDKey = class _HDKey {
    ...
    get privateExtendedKey() {
      ...
      return base58check2.encode(this.serialize(this.versions.private, concatBytes4(Uint8Array.of(0), priv)));
    }
    ...
    deriveChild(index) {
      ...
      if (index >= HARDENED_OFFSET2) {
        ...
        data = concatBytes4(Uint8Array.of(0), priv, data);
      } else {
        data = concatBytes4(this._publicKey, data);
      }
      const I = hmac2(sha512, this.chainCode, data);
      const childTweak = I.slice(0, 32);
      const chainCode = I.slice(32);
      if (!secp256k12.utils.isValidSecretKey(childTweak)) {
    ...
    sign(hash) {
      ...
      abytes3(hash, 32);
      return secp256k12.sign(hash, this._privateKey, { prehash: false });
    }
    verify(hash, signature) {
      ...
      return secp256k12.verify(signature, hash, this._publicKey, { prehash: false });
    }
    wipePrivateData() {
      if (this._privateKey) {
  ...
  return __toCommonJS(entry_yolo_exports);
})();
